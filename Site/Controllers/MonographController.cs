...
namespace Site.Controllers
{
    public class MonographController : Controller
    {
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                FROM 
                    ...
                    WHERE publication.publication_type = 'Monograph'
        ...
        public ActionResult MonographRegistrationView()
        {
        ...
        [HttpPost]
        public JsonResult MonographRegistration(Publication bookProperties, List<int> authors, MonographAndThesi monographAndThesisTable, List<EditionProperty> editionsProperty)
        {
            try
            {
                ...
                publication.publication_type = "Monograph";
                ...
                else
                {
                    ...
                    Session["added"] = true;
                    var redirect = Url.Action("MonographRegistrationView", "Monograph");
                    return Json(new
                    {
                        redirectTo = redirect
                    });
        ...
        [HttpPost]
        public JsonResult MonographDeletion(int id)
        {
            try
            {
        ...
        public ActionResult MonographDetailsView(long id)
        {
            try
            {
        ...
        public ActionResult MonographEditView(long id)
        {
            authorIds = "";
            try
            {
        ...
        [HttpPost]
        public JsonResult EditPublication(Publication bookProperties, MonographAndThesi monographAndThesis, List<int> authors)
        {
            try
            {
                int permission;
                ...
                var redirectTo = Url.Action("Index", "Monograph");
                return Json(new
                {
        ...
        public JsonResult AddSegment(EditionProperties editionsProperty)
        {
            try
            {
                ...
                var redirect = Url.Action("Index", "Monograph");
                return Json(new
                {
                    redirectTo = redirect
                });
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (totalEditionOfSegment > 1)
                    {
                        ...
                        {
                            db.SaveChanges(); var redirectTo = Url.Action("Index", "Monograph");
                            return Json(new
                            {
                                redirectTo = redirectTo
                            });
