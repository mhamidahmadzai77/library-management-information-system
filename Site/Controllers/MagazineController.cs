...
namespace Site.Controllers
{
    public class MagazineController : Controller
    {
        ...
        public ActionResult MagazineRegistrationView()
        {
        ...
        [HttpPost]
        public JsonResult MagazineRegistration(Publication bookProperties, List<int> authors, List<EditionProperties> editionsProperties)
        {
            try
            {
                ...
                else
                {
                    ...
                    Session["added"] = true;
                    var redirect = Url.Action("MagazineRegistrationView", "Magazine");
                    return Json(new
                    {
                        redirectTo = redirect
                    });
        ...
        [HttpPost]
        public JsonResult MagazineDeletion(int id)
        {
            try
            {
        ...
        public ActionResult MagazineEditView(long id)
        {
            authorIds = "";
            try
            {
        ...
        [HttpPost]
        public JsonResult EditPublication(Publication bookProperties, List<int> authors)
        {
            try
            {
                int permission;
                ...
                var redirectTo = Url.Action("Index", "Magazine");
                return Json(new
                {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (totalEditionOfSegment > 1)
                    {
                        ...
                        {
                            db.SaveChanges(); var redirectTo = Url.Action("Index", "Magazine");
                            return Json(new
                            {
                                redirectTo = redirectTo
                            });
        ...
        public JsonResult AddSegment(EditionProperties editionsProperty)
        {
            try
            {
                ...
                var redirect = Url.Action("Index", "Magazine");
                return Json(new
                {
                    redirectTo = redirect
                });
        ...
        public ActionResult MagazineDetailsView(long id)
        {
            try
            {
